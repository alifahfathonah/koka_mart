...
<!--[if lt IE 10]>
	...
	<link href="<?php echo base_url('assets/front_end/css/fontgapis.css') ?>" rel="stylesheet">
	<link href="<?php echo base_url('assets/front_end/css/fontqiucksand.css') ?>" rel="stylesheet">

	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/front_end/css/bootstrap.min.css') ?>">

	<link rel="stylesheet" href="<?php echo base_url('assets/front_end/css/waves.min.css') ?>" type="text/css" media="all">

	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/front_end/css/feather.css') ?>">

	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/front_end/css/font-awesome-n.min.css') ?>">

	<link rel="stylesheet" href="<?php echo base_url('assets/front_end/css/chartist.css') ?>" type="text/css" media="all">

	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/front_end/css/style.css') ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/front_end/css/widget.css') ?>">
</head>
<body>
			...
			<nav class="navbar header-navbar pcoded-header">
				<div class="navbar-wrapper">
					<div class="navbar-logo">
						<a href="index.html">
							<img class="img-fluid" src="<?php echo base_url('assets/front_end/png/logo.png') ?>" alt="Theme-Logo" />
						</a>
					...
					<div class="navbar-container container-fluid">
						...
						<ul class="nav-right">
							<li class="header-notification">
								<div class="dropdown-primary dropdown">
									...
									<ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
										...
										<li>
											<div class="media">
												<img class="img-radius" src="<?php echo base_url('assets/front_end/jpg/avatar-4.jpg') ?>" alt="Generic placeholder image">
										...
										<li>
											<div class="media">
												<img class="img-radius" src="<?php echo base_url('assets/front_end/jpg/avatar-3.jpg') ?>" alt="Generic placeholder image">
												<div class="media-body">
							...
							<li class="user-profile header-notification">
								<div class="dropdown-primary dropdown">
									<div class="dropdown-toggle" data-toggle="dropdown">
										<img src="<?php echo base_url('assets/front_end/jpg/avatar-4.jpg') ?>" class="img-radius" alt="User-Profile-Image">
										<span>John Doe</span>
							...
							<div class="main-friend-list">
								<div class="media userlist-box waves-effect waves-light" data-id="1" data-status="online" data-username="Josephin Doe">
									<a class="media-left" href="#!">
										<img class="media-object img-radius img-radius" src="<?php echo base_url('assets/front_end/jpg/avatar-3.jpg') ?>" alt="Generic placeholder image ">
								...
								<div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online" data-username="Lary Doe">
									<a class="media-left" href="#!">
										<img class="media-object img-radius" src="<?php echo base_url('assets/front_end/jpg/avatar-2.jpg') ?>" alt="Generic placeholder image">
										<div class="live-status bg-success"></div>
									</a>
									<div class="media-body">
								...
								<div class="media userlist-box waves-effect waves-light" data-id="3" data-status="online" data-username="Alice">
									<a class="media-left" href="#!">
										<img class="media-object img-radius" src="<?php echo base_url('assets/front_end/jpg/avatar-4.jpg') ?>" alt="Generic placeholder image">
										<div class="live-status bg-success"></div>
									</a>
									<div class="media-body">
								...
								<div class="media userlist-box waves-effect waves-light" data-id="4" data-status="offline" data-username="Alia">
									<a class="media-left" href="#!">
										<img class="media-object img-radius" src="<?php echo base_url('assets/front_end/jpg/avatar-3.jpg') ?>" alt="Generic placeholder image">
				...
				<div class="main-friend-chat">
					<div class="media chat-messages">
						<a class="media-left photo-table" href="#!">
							<img class="media-object img-radius img-radius m-t-5" src="<?php echo base_url('assets/front_end/jpg/avatar-2.jpg') ?>" alt="Generic placeholder image">
						</a>
...
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/jquery.min.js') ?>"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/jquery-ui.min.js') ?>"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/popper.min.js') ?>"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/bootstrap.min.js') ?>"></script>

<script src="<?php echo base_url('assets/front_end/js/waves.min.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>

<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/jquery.slimscroll.js') ?>"></script>

<script src="<?php echo base_url('assets/front_end/js/jquery.flot.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="<?php echo base_url('assets/front_end/js/jquery.flot.categories.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="<?php echo base_url('assets/front_end/js/curvedlines.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="<?php echo base_url('assets/front_end/js/jquery.flot.tooltip.min.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>

<script src="<?php echo base_url('assets/front_end/js/amcharts.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="<?php echo base_url('assets/front_end/js/serial.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="<?php echo base_url('assets/front_end/js/light.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>

<script src="<?php echo base_url('assets/front_end/js/markerclusterer.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/mapsapi.js') ?>"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/gmaps.js') ?>"></script>

<script src="<?php echo base_url('assets/front_end/js/pcoded.min.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="<?php echo base_url('assets/front_end/js/vertical-layout.min.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/crm-dashboard.min.js') ?>"></script>
<script type="2d8d78e876b340f9029c575b-text/javascript" src="<?php echo base_url('assets/front_end/js/script.min.js') ?>"></script>

<script async src="<?php echo base_url('assets/front_end/js/tagmanager.js') ?>" type="2d8d78e876b340f9029c575b-text/javascript"></script>
...
<script src="<?php echo base_url('assets/front_end/js/rocket-loader.min.js') ?>" data-cf-settings="2d8d78e876b340f9029c575b-|49" defer=""></script></body>
