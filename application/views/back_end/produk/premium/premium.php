		...
		<div class="col-lg-8">
			<div class="page-header-title">
				<div class="d-inline">
					...
					<span>Management Data Produk Premium</span>
				</div>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="page-header-breadcrumb">
				<ul class="breadcrumb-title">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url('back_end/produk/Premium') ?>">Premium</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="card">
		...
		<div class="card-block">
			<div class="btn-group" style="margin-bottom: 15px;">
				<a class="btn btn-primary" href="<?= site_url() ?>back_end/produk/Premium/add">
					...
					<tbody>
						...
						foreach ($premium as $data):?>
							<tr>
								...
								<td><a class="delete" onclick="deleteConfirm('<?= site_url(); ?>back_end/produk/Premium/delete/<?= $data->produk_id ?>')" href="#!"><button class="btn btn-danger"><i class="feather icon-trash"></i></button></a></td>
							</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
