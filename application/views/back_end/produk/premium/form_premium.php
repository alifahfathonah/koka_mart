...
<div class="col-sm-12">
    ...
    <div class="card">
        <div class="card-header">
            <h4><i class="feather icon-plus-square"></i>&nbsp;Add Produk Premium</h4>
            <hr>
        </div>
        <div class="card-block">
            
            <form method="POST" enctype="multipart/form-data" action="<?= site_url() ?>back_end/produk/Premium/add">
                ...
                <div class="form-group row" hidden>
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="produk_kategori_id" value="1" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="produk_deskripsi" class="ckeditor"></textarea>
                    </div>
                </div>
                <div class="form-group row">
...
<div class="col-sm-12">
    ...
    <div class="card">
        <div class="card-header">
            <h4><i class="feather icon-edit"></i>&nbsp;Edit Produk Premium</h4>
            <hr>
        </div>
        <div class="card-block">
            <form method="POST" enctype="multipart/form-data" action="<?php echo site_url('back_end/produk/Premium/edit/'.$row->produk_id); ?>">
